...
<div id="features" class="tabs t-bg2">
        <div class="container">
        <div class="Made-in">
            <img src="HomeFiles/images/madein_circle.png">
            </div>
                    ...
                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card left-pane">
                                        <div class="card-body">
                                            <div class="text-wrapper">
                                                ...
                                                <p><?php echo $Features_menu1_item3_comment; ?></p>
                                            </div>
                                            <div class="card-icon">
                                                <a class="popup-with-move-anim" href="#features-lightbox-3">
                                                    <div class="card-icon-effect-bgcolor-1"></div>
                                                    <i class="far fa fa-gem"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card left-pane first">
                                        <div class="card-body mt-e90">
                                            ...
                                            <div class="card-icon" style="background-color: #1d1d1d;">
                                                <a class="popup-with-move-anim" href="#features-lightbox-1">
                                                    <div class="card-icon-effect-bgcolor-2"></div>
                                    ...
                                    <div class="card left-pane">
                                        <div class="card-body">
                                            ...
                                            <div class="card-icon">
                                                <a class="popup-with-move-anim" href="#features-lightbox-2">
                                                    <div class="card-icon-effect-bgcolor-1"></div>
                                    ...
                                    <div class="card left-pane" >
                                        <div class="card-body">
                                            ...
                                            <div class="card-icon" style="background-color: #1d1d1d;">
                                                <a class="popup-with-move-anim" href="#features-lightbox-4">
                                                    <div class="card-icon-effect-bgcolor-2"></div>
                                    ...
                                    <div class="card left-pane" >
                                        <div class="card-body">
                                            <div class="text-wrapper">
                                                <h4 class="card-title"><?php echo $Features_menu1_item9; ?></h4>
                                                <p><?php echo $Features_menu1_item9_comment; ?></p>
                                            </div>
                                            <div class="card-icon">
                                                <a class="popup-with-move-anim" href="#features-lightbox-9">
                                                    <div class="card-icon-effect-bgcolor-1"></div>
                                ...
                                <!-- Image Pane -->
                                <div class="col-lg-4">
                                    <img class="img-fluid" src="<?php echo $Features_image_url_1; ?>" alt="<?php echo $Features_menu1_title; ?>">
                                </div>
                                <!-- end of image pane -->
                                ...
                                <div class="col-lg-4" >
                                    <div class="card right-pane first">
                                        <div class="card-body mt-e90">
                                            <div class="card-icon" >
                                                <a class="popup-with-move-anim" href="#features-lightbox-5">
                                                    <div class="card-icon-effect-bgcolor-1"></div>
                                                    <i class="far fa fa-mobile"></i>
                                                </a>
                                            </div>
                                            <div class="text-wrapper">
                                    ...
                                    <div class="card right-pane">
                                        <div class="card-body">
                                            <div class="card-icon" style="background-color: #1d1d1d;">
                                                <a class="popup-with-move-anim" href="#features-lightbox-6">
                                                    <div class="card-icon-effect-bgcolor-2"></div>
                                                    <i class="far fa fa-bookmark"></i>
                                                </a>
                                            </div>
                                            <div class="text-wrapper">
                                                <h4 class="card-title"><?php echo $Features_menu1_item5; ?></h4>
                                                <p class="w120"><?php echo $Features_menu1_item5_comment; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card right-pane">
                                        <div class="card-body">
                                            <div class="card-icon">
                                                <a class="popup-with-move-anim" href="#features-lightbox-7">
                                                    <div class="card-icon-effect-bgcolor-1"></div>
                                                    <i class="far fa fa-hand-point-right"></i>
                                                </a>
                                            </div>
                                            <div class="text-wrapper">
                                    ...
                                    <div class="card right-pane">
                                        <div class="card-body">
                                            <div class="card-icon" style="background-color: #1d1d1d;">
                                                <a class="popup-with-move-anim" href="#features-lightbox-8">
                                                    <div class="card-icon-effect-bgcolor-2"></div>
                                                    <i class="far fa fa-motorcycle"></i>
                                                </a>
                                            </div>
                                            <div class="text-wrapper">
                                                <h4 class="card-title"><?php echo $Features_menu1_item8; ?></h4>
                                                <p class="w120"><?php echo $Features_menu1_item8_comment; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card right-pane">
                                        <div class="card-body">
                                            <div class="card-icon">
                                                <a class="popup-with-move-anim" href="#features-lightbox-10">
                                                    <div class="card-icon-effect-bgcolor-1"></div>
                                                    <i class="far fa fa-thumbs-up"></i>
                                                </a>
                                            </div>
                                            <div class="text-wrapper">
                                                <h4 class="card-title"><?php echo $Features_menu1_item10; ?></h4>
                                                <p class="w120"><?php echo $Features_menu1_item10_comment; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                        <div class="container">
                            <div class="row">
                                <!-- Image Pane -->
                                <div class="col-md-4">
                                    <img class="img-fluid" src="<?php echo $Features_image_url_2; ?>" alt="<?php echo $Features_menu2_title; ?>">
                                </div>
                                <!-- end of image pane -->
                    ...
                    <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="icon-cards-area">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title"><?php echo $Features_menu3_item8; ?></h4>
                                                <p><?php echo $Features_menu3_item8_comment; ?></p>
                                            </div>
                                        </div>
                                    </div> <!-- end of icon cards area -->
                                ...
                                <!-- Image Pane -->
                                <div class="col-md-4">
                                    <img class="img-fluid" src="HomeFiles/images/tr/3.png" alt="<?php echo $Features_menu3_title; ?>">
                                </div>
                                <!-- end of image pane -->
