...
// Menu //
$Menu_1_title = "Home";
$Menu_2_title = "Features";
$Menu_3_title = "Preview";
$Menu_4_title = "Details";
$Menu_4_title_1 = "Privacy Policy";
$Menu_4_title_2 = "Cookie Policy";
$Menu_4_title_3 = "PDPL";
$Menu_5_title = "Contact";
// end Menu //
// Header //
$Header_title = 'digi<font style="color:#003da5">garson&reg;</font>';
$Header_slogan_content =  "Fast!, Hardworking!, Intelligent!";
$Header_comment = "It is not necessary to download an application to use DigiGarson! Simply scan the QR code on your phone.";
$Header_button_1 = "Contact";
$Header_button_2 = "Try Now!";
// end Header //
// Features //
$Features_title = "Features";
$Features_comment = "DigiGarson is the world's first and only automation program with unlimited options and QR code support.";
// Menu 1
$Features_menu1_title = "How to use?";
// Menu 1 item 1
$Features_menu1_item1 = "Menu";
...
";
$DetailsBox_button_2_title = "Details";
